package com.linyi.loginApp.keycloakstudy.config;
...
// Keycloak提供了一个很方便的基类KeycloakWebSecurityConfigurerAdapter来创建WebSecurityConfigurer实例，
// 因为任何由Spring Security保护的应用程序都需要一个配置类来扩展WebSecurityConfigurerAdapter：
